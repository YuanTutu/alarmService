...
> 当前版本 **v2.4.1** · 作者 yuanbo6 · 开发时间 2026-09-21
> 版本历史：v1.0 控制台版 → v2.0 WinForms 界面版（内嵌 https 证书）→ v2.1 标题与窗口布局调整 → v2.2 按钮高 DPI 等高对齐 → v2.3 未知部件按真实格式落盘 → v2.4 界面常显"/test 必填"提示 → v2.4.1 按现场反馈完善提示语
